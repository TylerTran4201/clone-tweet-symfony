...
class __TwigTemplate_0445a27eef996041057026b28506c242 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((twig_length_filter($this->env, (isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 5, $this->source); })())) > 0)) {
           ...
           ";
                // line 10
                $this->loadTemplate("hello/_message.html.twig", "hello/index.html.twig", 10)->display($context);
                // line 11
                echo "        ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "bố mày sửa tít le rồi nha con";
    ...
    {
        return array (  136 => 17,  125 => 15,  121 => 13,  118 => 12,  104 => 11,  102 => 10,  95 => 8,  92 => 7,  74 => 6,  72 => 5,  69 => 4,  59 => 3,  36 => 1,);
    }
...
<div>
    {% if messages|length > 0 %}
        {% for key,message in messages|slice(0, limit)%}
           ...
           {% include \"hello/_message.html.twig\" %}
        {% endfor %}
    {% else %}
        <b>Chưa có gì để show</b>
    {% endif %}
</div>
{% endblock %}
{% block title %}bố mày sửa tít le rồi nha con{% endblock %}", "hello/index.html.twig", "E:\\clone-tweet\\templates\\hello\\index.html.twig");
    }
}
