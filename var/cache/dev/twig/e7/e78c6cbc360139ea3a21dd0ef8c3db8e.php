...
class __TwigTemplate_abadc9d35ef3e88dde8279c363573221 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 12
        echo twig_include($this->env, $context, "micro_post/_post_list.html.twig", ["posts" => (isset($context["posts"]) || array_key_exists("posts", $context) ? $context["posts"] : (function () { throw new RuntimeError('Variable "posts" does not exist.', 12, $this->source); })())]);
        echo "
";
...
{% endblock %}", "profile/show.html.twig", "E:\\clone-tweet\\templates\\profile\\show.html.twig");
    }
}
