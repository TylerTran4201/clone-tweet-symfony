...
class __TwigTemplate_7aca84a84e6afdbe121f8a39ec97fb1b extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <div class=\"grid grid-cols-1 xl:grid-cols-2 gap-4 \">
    ...
    <div class=\"flex justify-between items-center bg-gray-200 bg-opacity-75 dark:bg-gray-700 dark:bg-opacity-75 p-3 rounded\">
      <div>
...
{% endif %}", "follower/_follower_list.html.twig", "E:\\clone-tweet\\templates\\follower\\_follower_list.html.twig");
    }
}
