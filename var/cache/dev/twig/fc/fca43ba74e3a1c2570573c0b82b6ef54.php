...
/* base.html.twig */
class __TwigTemplate_37758872a6e383d23ca48060ff72b41a extends Template
{
    private $source;
    private $macros = [];
...
<html class=\"dark\">
    ...
    <body class=\"bg-gray-100 text-gray-800 m-10 dark:bg-gray-800 dark:text-white\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 41
            echo "            <div class=\"rouded-md p-2 border-green-300 bg-green-50 border dark:border-green-600 dark:bg-green-700 dark:text-white mb-4\" style=\"color: green\">
                ";
            // line 42
...
";
    ...
    {
        return array (  222 => 46,  211 => 27,  201 => 26,  188 => 13,  178 => 12,  165 => 9,  155 => 8,  136 => 5,  122 => 47,  120 => 46,  117 => 45,  108 => 42,  105 => 41,  101 => 40,  92 => 34,  85 => 29,  83 => 26,  79 => 25,  67 => 15,  65 => 12,  62 => 11,  59 => 8,  54 => 5,  48 => 1,);
    }
    ...
    <body class=\"bg-gray-100 text-gray-800 m-10 dark:bg-gray-800 dark:text-white\">
        <div class=\"w-full md:w-2/3 mx-auto mb-4 flex justify-between items-center\">
            ...
            <div class=\"text-right\">
                <div class=\"text-sm text-gray-400 dark:text-gray-500\">
                    <div>Đăng Nhập & Đăng Ký ở đây</div>
                    <div>
                        <a href=\"{{ path('app_micro_post_add') }}\">tạo bài viết mới</a>
                    </div>
                </div>
            </div>
        </div>
        <div class=\"w-full md:w-2/3 mx-auto\">
           {% for message in app.flashes('success') %}
            <div class=\"rouded-md p-2 border-green-300 bg-green-50 border dark:border-green-600 dark:bg-green-700 dark:text-white mb-4\" style=\"color: green\">
                {{message}}
            </div>
            {% endfor %}
