...
class __TwigTemplate_dbbc1a0910837ac382dfe72834325cb6 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 14
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 14, $this->source); })()), "likedBy", [], "any", false, false, false, 14), "contains", [0 => twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "user", [], "any", false, false, false, 14)], "method", false, false, false, 14)) {
            // line 15
            echo "        <a href=\"";
        ...
        ";
            ...
            // line 19
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_like", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 19, $this->source); })()), "id", [], "any", false, false, false, 19)]), "html", null, true);
            echo "\">
            Like <span class=\"px-2 rounded-md bg-gray-200 dark:bg-gray-700\">";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 20, $this->source); })()), "likedBy", [], "any", false, false, false, 20), "count", [], "any", false, false, false, 20), "html", null, true);
            echo "</span>
        </a>
    ";
        }
    ...
    <div class=\"flex\">
        ...
        echo "\">comment<span class=\"ml-2 px-2 rounded-md bg-gray-200 dark:bg-gray-700\">";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 29, $this->source); })()), "comments", [], "any", false, false, false, 29), "count", [], "any", false, false, false, 29), "html", null, true);
        echo "</span></a>
    </div>
</div>";
    ...
    {
        return array (  110 => 29,  106 => 28,  98 => 25,  94 => 23,  88 => 20,  83 => 19,  77 => 16,  72 => 15,  70 => 14,  64 => 11,  58 => 8,  51 => 4,  47 => 3,  43 => 1,);
    }
    ...
    <div class=\"flex\">
        ...
        <a href=\"{{path('app_micro_post_comment',{post: post.id})}}\">comment<span class=\"ml-2 px-2 rounded-md bg-gray-200 dark:bg-gray-700\">{{post.comments.count}}</span></a>
    </div>
