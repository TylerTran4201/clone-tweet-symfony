...
class __TwigTemplate_a9ff7b42e2135924903453a0e0a5d6df extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "E:\\clone-tweet\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\messenger.html.twig");
    }
}
