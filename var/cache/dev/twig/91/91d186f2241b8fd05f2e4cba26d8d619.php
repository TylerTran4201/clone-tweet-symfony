...
class __TwigTemplate_92280deeaf6220b91fb18810d5d29740 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"text-xl dark:text-gray-200\">
        ";
        // line 44
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 44, $this->source); })()), "text", [], "any", false, false, false, 44), "html", null, true);
        echo "
    </div>
