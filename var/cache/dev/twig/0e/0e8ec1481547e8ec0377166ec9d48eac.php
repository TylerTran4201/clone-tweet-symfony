...
class __TwigTemplate_8098fd7ab636fa285e5869b64734beb9 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Chỉnh Sửa Bài Viết Mới{% endblock %}

{% block bread %}
<a href=\"{{path('app_micro_post_show',{post:post.id})}}\">Bài Viết</a> -> Chỉnh Sửa
{% endblock %}

{% block body %}
    {{include ('micro_post/_form.html.twig')}}
{% endblock %}", "micro_post/edit.html.twig", "E:\\clone-tweet\\templates\\micro_post\\edit.html.twig");
    }
}
