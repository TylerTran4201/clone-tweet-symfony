...
class __TwigTemplate_2e8f8ed6fb8fec445b2f4e38e47f7490 extends Template
{
    private $source;
    private $macros = [];
  ...
  {{ form_start(form) }}
        ...
        <div>
            ...
            {{ form_widget(form.title, {'attr': {'class': 'bg-gray-200 bg-opacity-40 dark:bg-gray-500 dark:bg-opacity-40 border rounded  text-xs font-medium leading-none text-gray-800 dark:text-gray-200 py-3 w-full pl-3 mt-2'}})}}
